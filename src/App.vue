...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue Italic'), url('assets/fonts/HelveticaNeueItalic.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 27 Ultra Light Condensed Oblique'), url('assets/fonts/HelveticaNeue-UltraLigCondObl.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 107 Extra Black Condensed Oblique'), url('assets/fonts/HelveticaNeue-ExtBlackCondObl.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue UltraLight'), url('assets/fonts/HelveticaNeueUltraLight.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue UltraLight Italic'), url('assets/fonts/HelveticaNeueUltraLightItal.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 45 Light'), url('assets/fonts/HelveticaNeue-Light.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 47 Light Condensed'), url('assets/fonts/helvetica-47-light-condensed-587ebd7b5a6f6.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue Light Italic'), url('assets/fonts/HelveticaNeueLightItalic.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 46 Light Italic'), url('assets/fonts/helvetica-46-light-italic-587ebdb0ea724.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 65 Medium'), url('assets/fonts/HelveticaNeue-Medium.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 67 Medium Condensed Oblique'), url('assets/fonts/HelveticaNeue-MediumCondObl.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue Condensed Bold'), url('assets/fonts/HelveticaNeueCondensedBold.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica 75 Bold Outline'), url('assets/fonts/helvetica-75-bold-outline-587ebe00b76ba.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue Bold Italic'), url('assets/fonts/HelveticaNeueBoldItalic.woff') format('woff');
}
...
font-style: normal;
font-weight: normal;
src: local('Helvetica Neue Condensed Black'), url('assets/fonts/HelveticaNeueCondensedBlack.woff') format('woff');
}
